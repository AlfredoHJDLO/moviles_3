...
import 'package:tienda/screens/products_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        title: 'Boodega Aurrerá en linea',
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Boodega Aurrerá", style: TextStyle(color: Colors.white)),
          leading: const Padding(
          padding: EdgeInsets.all(5.0),
          child: CircleAvatar(
             backgroundImage: AssetImage("lib/src/aurrera.png"),
            ),
          ),
          bottom: TabBar(
